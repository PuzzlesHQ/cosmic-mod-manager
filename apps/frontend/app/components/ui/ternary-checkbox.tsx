...
export function TernaryCheckbox(props: ThreeStateCheckboxProps) {
    ...
    return (
        ...
        <button
            ...
            onClick={handleClick}
            className={cn(
                "focus-visible:focus_ring flex h-4 w-4 cursor-pointer items-center justify-center rounded-sm",
...
export function LabelledTernaryCheckbox(props: LabelledCheckboxProps) {
    return (
        <Label
            className={cn(
                "flex cursor-not-allowed items-center justify-start gap-x-2 py-1.25 font-normal text-base text-foreground-muted opacity-75 transition",
