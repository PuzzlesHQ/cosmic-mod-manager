				...
				<div className="mb-1 flex flex-wrap items-center justify-start gap-3" style={{ gridArea: "info" }}>
					<div className="flex items-center justify-center gap-1.5">
						{profileUrl ? (
							...
							<span className={cn("w-fit font-medium text-base leading-none", userNameColor)}>{authorUsername}</span>
						)}
				...
				<Popover>
					...
					<PopoverContent className="min-w-0 p-1" align="end">
						<PopoverClose asChild>
							<Button variant="ghost" size="sm" onClick={() => props.setReplyingTo(msg.id)} className="justify-start">
