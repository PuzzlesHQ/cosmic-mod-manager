...
export default {
	...
	auth: {
		...
		agreement: (terms, privacyPolicy) => ["En créant un compte, vous acceptez nos ", terms, " et ", privacyPolicy, "."],
	...
	chatThread: {
		...
		changedProjectStatus: (oldStatus, newStatus) => ["changé le statut du projet de ", oldStatus, " vers ", newStatus],
