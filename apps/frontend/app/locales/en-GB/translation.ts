...
export default {
	...
	settings: {
		...
		personalAccessTokensDesc: (siteName_short: string, docsUrl: string) =>
			`PATs can be used to access ${siteName_short}'s API. For more information, see [${siteName_short}'s API documentation](${docsUrl}). They can be created and revoked at any time.`,
	...
	projectSettings: {
		...
		inviteOrgMemberDesc: "Enter the username of the person you'd like to invite to be a member of this organisation.",
		invite: "Invite",
	...
	moderation: {
		...
		statusDesc: {
			...
			withheld: "Project has been withheld and is not publicly visible. Please check the moderation tab for more info.",
