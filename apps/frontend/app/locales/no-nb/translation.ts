...
export default {
    ...
    project: {
        ...
        publishingChecklist: {
            ...
            resubmit_ProjectWithheld:
                "Prosjektet ditt har blitt holdt tilbake av moderatoren vår. I de fleste tilfeller kan du sende det inn til ny vurdering etter at du har fulgt opp på det som står i moderatorens melding.",
            visit: {
    ...
    moderation: {
        ...
        statusDesc: {
            ...
            withheld:
                "Prosjektet er holdt tilbake og er ikke offentlig synlig. Se modereringsfanen for mer informasjon.",
        },
        pageDesc:
    ...
    meta: {
        ...
        siteDesc: (siteName_long, siteName_short) =>
            `Last ned modifikasjoner for Cosmic Reach, som plugins, datamodifikasjoner, gjengivere, ressurspakker, og modifikasjonspakker på ${siteName_short} (${siteName_long}). Oppdag og publiser prosjekter for alt nevnt på ${siteName_short} med et moderne, brukervennlig grensesnitt og API.`,
