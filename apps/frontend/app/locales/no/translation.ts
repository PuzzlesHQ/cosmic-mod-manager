...
export default {
    ...
    dashboard: {
        ...
        invitedToJoin: (user, team) => [
            user,
            " har invitert deg til å bli med ",
            team,
        ],
...
",
    ...
    project: {
        ...
        doesNotSupport: (project, version, loader) => {
            ${project} støtter ikke versjonen ${version} for ${loader}
        },
        ...
        declinedInvitation: "Avslo invitasjon",
        ...
        publishingChecklist: {
            ...
            addDescriptionDesc: "En beskrivelse som tydelig beskriver meningen med og innholdet i prosjektet kreves.",
            ...
            submitForReview: "Send in for evaluering",
            ...
            resubmit_ProjectWithheld: "Prosjektet ditt har blitt tilbakeholdt av moderatoren vår. I de fleste tilfeller kan du sende det inn til ny vurdering etter at du har fulgt opp på det som står i moderatorens melding.",
            visit: {
    ...
    report: {
        ...
        violationType: {
            ...
            reuploaded_work_desc: {
                _1: "Vær oppmerksom på at dette fremdeles *ikke* er en DMCA-forespørsel om fjerning av innhold, men snarere bare en rapport om andresinnhold som er lastet opp på nytt.",
                _2: (copyrightPolicy) => [
...
",
    ...
    meta: {
        ...
        siteDesc: (siteName_long, siteName_short) => `Last ned modifikasjoner for Cosmic Reach, som plugins, datamodifikasjoner, skjermskildrere, ressurspakker, og modifikasjonspakker på ${siteName_short} (${siteName_long}). Oppdag og publiser prosjekter for alt nevnt på ${siteName_short} med et moderne, brukervennlig grensesnitt og API.`,
