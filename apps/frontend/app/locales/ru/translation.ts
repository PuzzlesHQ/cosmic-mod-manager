...
export default {
	...
	auth: {
		...
		dontHaveAccount: (signup) => ["Не зарегистрированы? ", signup],
	...
	projectSettings: {
		...
		sureToTransferOwnership: (memberName) => `Вы уверены, что хотите передать роль владельца участнику ${memberName}?`,
	},
