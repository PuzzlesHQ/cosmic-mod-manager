...
function OrgInfoHeader({
	...
	return (
		<div className="page-header flex w-full flex-col gap-1">
			...
			>
				<LabelledIcon icon={<UsersIcon aria-hidden className="h-[1.1rem] w-[1.1rem]" />} className="font-semibold">
					{t.count.members(orgData.members.length, FormatCount(orgData.members.length, formattedLocaleName))}
				</LabelledIcon>

				<LabelledIcon icon={<CubeIcon aria-hidden className="h-btn-icon-md w-btn-icon-md" />} className="font-semibold">
