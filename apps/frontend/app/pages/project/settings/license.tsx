...
`}
						...
						<div className="flex w-full min-w-[32ch] flex-col items-start justify-start md:w-[52ch]">
								...
								<>
									...
									{doesNotHaveASpdxId && (
										<FormField
											...
											render={({ field }) => (
												<FormItem>
													<Input {...field} value={field.value ?? ""} placeholder={t.projectSettings.licenseName} />
													<FormMessage />
												</FormItem>
											)}
										/>
									...
									{!doesNotHaveASpdxId && (
										<FormField
											...
											render={({ field }) => (
												<FormItem>
													<Input {...field} value={field.value ?? ""} placeholder={t.projectSettings.spdxId} />
													<FormMessage />
												</FormItem>
											)}
										/>
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										<Input {...field} value={field.value ?? ""} placeholder={t.projectSettings.licenseUrl} />
										<FormMessage />
									</FormItem>
								)}
							/>
