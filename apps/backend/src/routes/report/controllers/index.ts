...
export async function createReport(data: z.infer<typeof newReportFormSchema>, user: SessionUserData) {
...
export async function getAllUserReports(user: SessionUserData, userId?: string, filters?: ReportFilters) {
